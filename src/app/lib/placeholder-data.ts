...
export const bodFiles: filesProps[] = [
	{
		name: 'Alh. Olatinwo Tajudeen Olawale',
		position: 'Chairman, Board of Directors',
		url: '/images/chairman.svg',
		width: 350,
		height: 350,
	},
	{
		name: 'Ayobami Ogunkeye',
		position:
			'Executive Director, Corporate Services, Zylus Group International',
		url: '/images/cooperate.svg',
		width: 350,
		height: 350,
	},
	{
	...
	{
		name: 'Nathaniel Ihechiluru Ojukwu',
	...
	{
		name: 'Joseph Funmilayo Viutiu',
		position: 'Head Compliance',
		url: '/images/compliance.svg',
		width: 350,
		height: 350,
	},
	{
		name: 'Salam Ismail Oluwole ',
	...
	{
		name: 'Adefemi Adetoyese Abraham',
	...
	{
		name: 'Ayobami Isaac Adesina ',
		position: 'Head Internal Audit',
		url: '/images/audit.svg',
		width: 350,
		height: 350,
	},
	{
